...
class HTML5Media extends Native {
    ...
    constructor(element: HTMLMediaElement, media?: Source) {
        ...
        const sources = getMediaFiles(element);
        this.#isStreaming = isHlsSource(media || sources[0]);
        ...
        if (typeof this.element.textTracks.addEventListener === 'function') {
    ...
    destroy(): HTML5Media {
        ...
        if (typeof this.element.textTracks.removeEventListener === 'function') {
