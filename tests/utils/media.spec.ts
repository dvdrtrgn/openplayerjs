...
describe('utils > media', () => {
    ...
    test('determines the extension of a source', (done) => {
    ...
    test('determines if media source is an HLS resource', (done) => {
        expect(
            media.isHlsSource({
    ...
    test('determines if media source is an HLS playlist resource', (done) => {
        expect(
            media.isM3USource({
    ...
    test('determines if media source is an MPEG-DASH resource', (done) => {
        expect(
            media.isDashSource({
    ...
    test('determines if media source is an FLV resource', (done) => {
        expect(
            media.isFlvSource({
    ...
    test('predicts the extension of a media source based on the URL provided', (done) => {
    ...
    // test('checks if browser can autoplay media without being muted', () => {
    //     const video = document.getElementById('video') as HTMLMediaElement;
    //     video.muted = false;
    ...
    //     });
    // });
    // test('checks if browser can autoplay media being muted', async () => {
    //     const audio = document.getElementById('audio') as HTMLMediaElement;
